...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$lib$2f$model$2f$user$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/lib/model/user.js [app-route] (ecmascript)");
...
async function POST(request) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            result: "Thank you for registering! Your account is currently under review and will be activated within 2 hours.",
            success: true,
            status: 201
        });
    } catch (error) {
...
function getConnectionString() {
    ...
    if (!username || !password) {
        throw new Error("Missing MongoDB credentials. Set MONGODB_URI (recommended) or username/password in environment variables.");
    }
...
async function connectDB() {
    ...
    if (!cached.promise) {
        ...
        cached.promise = __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$2c$__$5b$project$5d2f$node_modules$2f$mongoose$29$__["default"].connect(connectionString, {
...
"[project]/src/app/lib/model/user.js [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0o1q6__._.js.map